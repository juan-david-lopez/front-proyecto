    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="px-6 pb-16">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Plan Básico */}
          <Card className="bg-gray-800 border-gray-700 text-white relative h-full">
          ...
          {/* Plan Premium */}
          <Card className="bg-gray-800 border-2 border-red-500 text-white relative h-full">
          ...
          <Card className="bg-gray-800 border-gray-700 text-white relative">
            <CardContent className="p-8">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-300 mb-2">Elite</h2>
              ...
              <Button
                ...
                aria-describedby="plan-elite-description"
              >
                Seleccionar Plan
              </Button>
              <div id="plan-elite-description" className="sr-only">
                Plan Elite por $90,000 pesos mensuales con acceso premium y beneficios exclusivos
              </div>
            </CardContent>
          </Card>
        </div>
